...
if __name__ == '__main__':
	elems=['Pt','Pd','Co']
	set_elem= 'Pt' #elems[2]
	d=2.78 #2.75 Pd, 2.78 Pt, Ni 2.49
	name = 'shellPt-FCC-cs1.xyz' # name of file to be created
	opmode = 'c'
...
for ns in range(4,capas):
	coords = cubeShell(ns,d)
	coords = sphericalShave(coords,15)

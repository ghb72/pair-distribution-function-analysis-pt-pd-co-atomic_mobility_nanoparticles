...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\05_31_2024_probes_w_temp_vac\pruebas_vac\p3_d2.xyz')
read(10,*) npart
...
open(unit=11,file='p3_d2.txt',action='write',status='replace')

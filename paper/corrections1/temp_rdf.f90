...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\paper\corrections1\partial_Co-Co.xyz')
read(10,*) npart
...
open(unit=11,file='partial_Co-Co.txt',action='write',status='replace')

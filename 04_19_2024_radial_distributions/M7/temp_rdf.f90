...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\19_de_abril\M7\M0-polrad_7_d2.xyz')
read(10,*) npart
...
open(unit=11,file='M0-polrad_7_d2.txt',action='write',status='replace')

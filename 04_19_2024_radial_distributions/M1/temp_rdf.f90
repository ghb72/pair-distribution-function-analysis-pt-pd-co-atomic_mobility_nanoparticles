...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\19_de_abril\M1\M0-polrad_1_d2.xyz')
read(10,*) npart
...
open(unit=11,file='M0-polrad_1_d2.txt',action='write',status='replace')

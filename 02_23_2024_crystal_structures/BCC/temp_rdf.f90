...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\02_23_2024_crystal_structures\BCC\BCC.xyz')
read(10,*) npart
...
open(unit=11,file='BCC.txt',action='write',status='replace')

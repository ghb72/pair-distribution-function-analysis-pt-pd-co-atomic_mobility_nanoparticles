...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\02_23_2024_crystal_structures\ICO\ICO.xyz')
read(10,*) npart
...
call smooth(hs1,9,hs2)
call smooth(hs2,9,hs1)
...
open(unit=11,file='ICO.txt',action='write',status='replace')

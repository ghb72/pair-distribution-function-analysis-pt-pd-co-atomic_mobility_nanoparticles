...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\03_01_2025_sandwich_coreshell_janus_notebooks\Ni_0.5_sandwich\Ni_0.5_sandwich_d.xyz')
read(10,*) npart
...
open(unit=11,file='Ni_0.5_sandwich_d.txt',action='write',status='replace')

...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\03_01_2025_sandwich_coreshell_janus_notebooks\Janus_0.5\janus-0.5_d.xyz')
read(10,*) npart
...
open(unit=11,file='janus-0.5_d.txt',action='write',status='replace')

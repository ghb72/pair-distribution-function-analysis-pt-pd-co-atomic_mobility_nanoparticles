program rdf
implicit none
integer, parameter :: nhis=1550
integer :: i,j,npart,ngr,ig,m,b1,b2,b3
...
call smooth(hist,10,hs1)
call smooth(hs1,10,hs2)
call smooth(hs2,10,hs1)
call smooth(hist,100,hs2)
call smooth(hs2,100,base) !hist-> hs2
gr = hs1-base

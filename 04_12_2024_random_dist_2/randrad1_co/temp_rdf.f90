...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\04_12_2024_random_dist_2\randrad1_co\Mix-co-radrand_d2.xyz')
read(10,*) npart
...
open(unit=11,file='Mix-co-radrand_d2.txt',action='write',status='replace')

...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\04_12_2024_random_dist_2\randrad2_co\Mix-co-radrand2_d2.xyz')
read(10,*) npart
...
open(unit=11,file='Mix-co-radrand2_d2.txt',action='write',status='replace')

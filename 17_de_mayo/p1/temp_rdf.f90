...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\17_de_mayo\p1\M0-polrad_1_d.xyz')
read(10,*) npart
...
open(unit=11,file='M0-polrad_1_d.txt',action='write',status='replace')

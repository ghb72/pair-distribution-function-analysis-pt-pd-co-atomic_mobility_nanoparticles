...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\17_de_mayo\p2\M0-polrad_8_d.xyz')
read(10,*) npart
...
open(unit=11,file='M0-polrad_8_d.txt',action='write',status='replace')

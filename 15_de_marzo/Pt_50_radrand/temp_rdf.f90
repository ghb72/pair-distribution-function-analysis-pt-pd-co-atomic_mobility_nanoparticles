...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\15_de_marzo\Pt_50_radrand\Pt-0.5-radrand_d.xyz')
read(10,*) npart
...
open(unit=11,file='Pt-0.5-radrand_d.txt',action='write',status='replace')

...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\15_de_marzo\Ni_100\Ni-FCC_d.xyz')
read(10,*) npart
...
open(unit=11,file='Ni-FCC_d.txt',action='write',status='replace')

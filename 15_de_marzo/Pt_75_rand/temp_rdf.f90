...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\15_de_marzo\Pt_75_rand\Pt-0.75-rand_d.xyz')
read(10,*) npart
...
open(unit=11,file='Pt-0.75-rand_d.txt',action='write',status='replace')

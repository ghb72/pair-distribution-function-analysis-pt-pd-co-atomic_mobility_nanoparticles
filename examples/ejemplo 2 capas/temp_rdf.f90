...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\ejemplo\ejemplo 2 capas\ejem1.xyz')
read(10,*) npart
...
call smooth(hs1,0,hs2)
call smooth(hs2,0,hs1)
...
open(unit=11,file='ejem1.txt',action='write',status='replace')

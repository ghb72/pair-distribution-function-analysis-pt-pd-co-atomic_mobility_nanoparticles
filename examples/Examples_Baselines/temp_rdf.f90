...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\ejemplo\EjemplificiacionBaselines\cube_d.xyz')
read(10,*) npart
...
call smooth(hs1,20,hs2)
call smooth(hs2,20,hs1)
...
!print*, shape(h)
!print*, ele, x(0), y(0), z(0),b(0),bm
!print*, ele, x(1), y(1), z(1),b(1),bm
!print*, ele, x(2), y(2), z(2),b(2),bm
open(unit=11,file='cube_d.txt',action='write',status='replace')

...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\15_de_marzo\Pt_25_radrand\Pt-0.25-radrand_d.xyz')
read(10,*) npart
...
open(unit=11,file='Pt-0.25-radrand_d.txt',action='write',status='replace')

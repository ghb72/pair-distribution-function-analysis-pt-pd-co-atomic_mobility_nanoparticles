...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\15_de_marzo\Pt_100\Pt-FCC_d.xyz')
read(10,*) npart
...
open(unit=11,file='Pt-FCC_d.txt',action='write',status='replace')

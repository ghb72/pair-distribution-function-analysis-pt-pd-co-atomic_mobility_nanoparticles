...
open(unit=10,file='c:\Users\guill\OneDrive\Documentos\Tesis\Proyect\26_de_abril\FittingM1_powdist_maxin\probe_d2.xyz')
read(10,*) npart
...
open(unit=11,file='probe_d2.txt',action='write',status='replace')
